...
class TestGitlabContextParser {
    ...
    @test public async testTreeContext_03() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/AlexTugarev/gp-test/tree/wip/README.md');
        expect(result).to.deep.include({
            "ref": "wip",
            "refType": "branch",
            "path": "README.md",
    ...
    @test public async testCommitContext_01() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/AlexTugarev/gp-test/-/commit/80948e8cc8f0e851e89a10bc7c2ee234d1a5fbe7');
        expect(result).to.deep.include({
            "ref": "",
            "refType": "revision",
            "path": "",
    ...
    @test public async testCommitContext_02_notExistingCommit() {
        try {
            await this.parser.handle({}, this.user, 'https://gitlab.com/AlexTugarev/gp-test/-/commit/aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa');
    ...
    @test public async testPullRequestContext_01() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/AlexTugarev/gp-test/merge_requests/2');
        expect(result).to.deep.include(
            {
    ...
    @test public async testTreeContextSubgroup_01() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup');
        expect(result).to.deep.include({
            "ref": "master",
            "refType": "branch",
            "path": "",
    ...
    @test public async testTreeContextSubgroup_02() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/tree/branchtwo');
        expect(result).to.deep.include({
            "ref": "branchtwo",
            "refType": "branch",
            "path": "",
    ...
    @test public async testTreeContextSubgroup_03() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/tree/branchtwo/README.md');
        expect(result).to.deep.include({
            "ref": "branchtwo",
            "refType": "branch",
            "path": "README.md",
    ...
    @test public async testTreeContextSubgroup_04() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/tree/master');
        expect(result).to.deep.include({
            "ref": "master",
            "refType": "branch",
            "path": "",
    ...
    @test public async testTreeContextSubgroup_05() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/blob/master/test%20dir%20with%20spaces/file%20with%20spaces.txt');
        expect(result).to.deep.include({
            "ref": "master",
            "refType": "branch",
    ...
    @test public async testTreeContextSubgroup_tag_01() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/tree/test-tag');
        expect(result).to.deep.include({
            "ref": "test-tag",
            "refType": "tag",
    ...
    @test public async testIssueContextSubgroup_01() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/issues/1');
        expect(result).to.deep.include(
            {
    ...
    @test public async testTreeContextBranchWithSlash() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/tree/corneliusludmann/important-issue-1');
        expect(result).to.deep.include({
    ...
    @test public async testTreeContextTagWithSlash() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/tree/tag/withslash');
        expect(result).to.deep.include({
            "ref": "tag/withslash",
            "refType": "tag",
            "revision": "f2e1ef56733e7507f766d8ada01f6570c0f3e921",
    ...
    @test public async testTreeContextBranchWithSlashAndPathWithSpaces() {
        const result = await this.parser.handle({}, this.user, 'https://gitlab.com/gp-test-group/gp-test-subgroup/gp-test-project-in-subgroup/blob/corneliusludmann/important-issue-1/test%20dir%20with%20spaces/file%20with%20spaces.txt');
        expect(result).to.deep.include({
            "ref": "corneliusludmann/important-issue-1",
            "refType": "branch",
            "revision": "d71db0ad147954553233ba66df6f54a2ae7c74bd",
