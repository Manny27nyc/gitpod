...
export class LicenseDB1593167873419 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("CREATE TABLE IF NOT EXISTS `d_b_license_key` (`id` char(36) NOT NULL, `installationTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `key` text NOT NULL, PRIMARY KEY(`id`)) ENGINE=InnoDB");
    }
